...
class Deduplicator:
    ...
    def _group_to_unified(self, group: ArticleGroup) -> UnifiedItem:
        ...
        return UnifiedItem(
            ...
            index_relevant=primary.classification.index_relevant,
            taxonomy_version=primary.classification.taxonomy_version,
            taxonomy_category_id=primary.classification.taxonomy_category_id,
            taxonomy_subcategory_id=primary.classification.taxonomy_subcategory_id,
